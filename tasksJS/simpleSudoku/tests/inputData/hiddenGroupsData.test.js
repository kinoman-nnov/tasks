...
const hiddenThreesomeMap = {
  mainTable: {
    ...
    4: [
      { value: 9, address: { axisX: 'sectionX1.row0', axisY: 'sectionY1.column0', innerTableId: 4 } },
      { value: 2, address: { axisX: 'sectionX1.row0', axisY: 'sectionY1.column1', innerTableId: 4 } },
      { value: 4, address: { axisX: 'sectionX1.row0', axisY: 'sectionY1.column2', innerTableId: 4 } },
      { value: [7, 8], address: { axisX: 'sectionX1.row1', axisY: 'sectionY1.column0', innerTableId: 4 } },
      { value: 5, address: { axisX: 'sectionX1.row1', axisY: 'sectionY1.column1', innerTableId: 4 } },
      { value: [7, 8], address: { axisX: 'sectionX1.row1', axisY: 'sectionY1.column2', innerTableId: 4 } },
      { value: 1, address: { axisX: 'sectionX1.row2', axisY: 'sectionY1.column0', innerTableId: 4 } },
      { value: 3, address: { axisX: 'sectionX1.row2', axisY: 'sectionY1.column1', innerTableId: 4 } },
      { value: 6, address: { axisX: 'sectionX1.row2', axisY: 'sectionY1.column2', innerTableId: 4 } }
    ],
    7: [
      { value: 3, address: { axisX: 'sectionX2.row0', axisY: 'sectionY1.column0', innerTableId: 7 } },
      { value: 6, address: { axisX: 'sectionX2.row0', axisY: 'sectionY1.column1', innerTableId: 7 } },
      { value: [2, 8], address: { axisX: 'sectionX2.row0', axisY: 'sectionY1.column2', innerTableId: 7 } },
      { value: [2, 5, 7], address: { axisX: 'sectionX2.row1', axisY: 'sectionY1.column0', innerTableId: 7 } },
      { value: 1, address: { axisX: 'sectionX2.row1', axisY: 'sectionY1.column1', innerTableId: 7 } },
      { value: 9, address: { axisX: 'sectionX2.row1', axisY: 'sectionY1.column2', innerTableId: 7 } },
      { value: [2, 4, 5, 7, 8], address: { axisX: 'sectionX2.row2', axisY: 'sectionY1.column0', innerTableId: 7 } },
      { value: [4, 7, 8], address: { axisX: 'sectionX2.row2', axisY: 'sectionY1.column1', innerTableId: 7 } },
      { value: [2, 5, 7, 8], address: { axisX: 'sectionX2.row2', axisY: 'sectionY1.column2', innerTableId: 7 } }
    ]
  },
  get objToCheck() {
    return {
...
export { hiddenPairMap, hiddenPairMap_2, hiddenThreesomeMap, hiddenFourMap }